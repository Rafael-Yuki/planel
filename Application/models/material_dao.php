...
class MaterialDAO {
    public static function criarMaterial($nome_material, $valor_compra, $valor_venda, $data_compra, $quantidade, $unidade_medida, $fornecedor_id) {
        global $conexao;
        ...
        $sql = "INSERT INTO materiais (nome_material, valor_compra, valor_venda, data_compra, quantidade, unidade_medida, fk_fornecedores_id_fornecedor, ativo) 
                VALUES ('$nome_material', '$valor_compra', '$valor_venda', '$data_compra', '$quantidade', '$unidade_medida', $fornecedor_id, TRUE)";
        
        mysqli_query($conexao, $sql);
        return mysqli_affected_rows($conexao);
    }

    public static function editarMaterial($id, $nome_material, $valor_compra, $valor_venda, $data_compra, $quantidade, $unidade_medida, $fornecedor_id) {
        global $conexao;
        ...
        $unidade_medida = mysqli_real_escape_string($conexao, trim($unidade_medida));
        $fornecedor_id = mysqli_real_escape_string($conexao, $fornecedor_id);

        $sql = "UPDATE materiais SET nome_material = '$nome_material', valor_compra = '$valor_compra', valor_venda = '$valor_venda', 
        data_compra = '$data_compra', quantidade = '$quantidade', unidade_medida = '$unidade_medida', fk_fornecedores_id_fornecedor = '$fornecedor_id' 
