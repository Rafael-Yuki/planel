...
class MaterialDAO {
    public static function criarMaterial($nome_material, $valor_compra, $valor_venda, $data_compra, $quantidade, $unidade_medida, $fornecedor_id, $ncm) {
        global $conexao;
        ...
        $sql = "INSERT INTO materiais (nome_material, valor_compra, valor_venda, data_compra, quantidade, unidade_medida, fk_fornecedores_id_fornecedor, ativo, ncm) 
                VALUES ('$nome_material', '$valor_compra', '$valor_venda', '$data_compra', '$quantidade', '$unidade_medida', $fornecedor_id, TRUE, '$ncm')";
