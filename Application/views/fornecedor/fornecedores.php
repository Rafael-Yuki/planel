            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="fornecedor/cadastro" class="btn btn-primary">
                            <span class="bi-person-plus-fill me-2"></span>Adicionar Fornecedor
                        </a>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        if (mysqli_num_rows($fornecedores) > 0) {
                            ...
                            <div class="table-responsive">
                                <table id="fornecedoresTable" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>Nome</th>
                                        <th>CNPJ</th>
